    ...
    return (
        <div className="card text-center d-flex align-items-center justify-content-center" style={{height: '250px'}}>
            <div className="card-body">
                <p className="card-title appliances">Upto 60% off on Appliances</p>
                ...
                <p className="card-text appliances1 mt-4">Upto 60% off on summer Appliances</p>
                <a href="#" className="btn btn-danger">GRAB NOW</a>
            </div>
        </div>
    );
}
